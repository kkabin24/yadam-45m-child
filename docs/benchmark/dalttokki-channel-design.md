# 「달토끼네 잠자리동화」 채널 설계서 (v0.2 · 2026-09-20)
...
|---|---|
| 채널명 | **달토끼네 잠자리동화** |
| 핸들 | `@달토끼네` (영문 대체 `@dalttokkine`) — ★2026-09-20 채널명 「달토끼 잠자리동화」→「달토끼네 잠자리동화」 개정. 기존 「달토끼 | Daltoki」(밤 감성음악 채널)와 검색 혼동을 피하고 "~네"로 머리맡·집 정서를 더한다 |
| 마스코트 | 아기 달토끼 **「몽이」** (夢 — 꿈) |
